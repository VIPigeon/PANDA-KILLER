...
Physics.check_collision_rect_rect(player.hitbox:to_rect(player.x, player.y), ...)

или

Physics.check_collision_rect_rect(Hitbox.rect_of(player), ...)

Советую использовать Hitbox.rect_of, поскольку он лаконичнее
