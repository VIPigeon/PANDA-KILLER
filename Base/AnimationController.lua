...
function AnimationController:draw(x, y, flip, rotate)
    ...
    local crutching_coordinate_addition = math.floor(current_scale / 2)

    -- тут произошла математика, надо пофиксить
    local spr_x = x -- + crutching_coordinate_addition -- * 1.67
    local spr_y = y -- - math.ceil((current_scale) * crutching_coordinate_addition)
