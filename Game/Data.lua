...
KILL_COUNTER_RESET_TIME       = 5.0   -- секунды до сброса серии
KILL_COUNTER_SHAKE_DURATION   = 0.15  -- длительность встряски счётчика (сек)
KILL_COUNTER_SHAKE_MAGNITUDE  = 2.0   -- амплитуда встряски (пиксели)
KILL_COUNTER_BLINK_THRESHOLD  = 1.5   -- остаток времени, при котором начинается мигание (сек)
KILL_COUNTER_BLINK_PERIOD     = 0.2   -- период мигания (сек)
...
PLAYER_MAX_HEALTH = 3
PLAYER_INVULNERABILITY_DURATION = 2.0          -- секунды
PLAYER_INVULNERABILITY_BLINK_PERIOD = 0.1      -- секунды на одно мигание
PLAYER_DAMAGE_KNOCKBACK_HORIZONTAL = 120       -- пиксели/сек (> PLAYER_MAX_HORIZONTAL_SPEED=67, иначе клэмп сбрасывает knockback)
PLAYER_DAMAGE_KNOCKBACK_VERTICAL = 100
...
PANDA_LYING_DOWN_HITBOX = Hitbox:new(4, 4, 8, 4)
